...
export const ADVENTURE_MAX_LIVES = 3;
...
export const HURT_FLASH_MS = 750;
export const HURT_INVULNERABLE_MS = 900;
export const HURT_SHRINK_MAX = 2;
export const MIN_SURVIVABLE_SNAKE_LENGTH = 3;
